...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(
	  ...
	  React.createElement(
	    ...
	    React.createElement(IndexRoute, { component: Weather, city: 'Rectburg' })
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	  ...
	  handleNewProps: function handleNewProps(city) {
	    this.setState({
	      city: city
	    });
	  },
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(WeatherForm, { onNewCity: this.handleNewProps }),
